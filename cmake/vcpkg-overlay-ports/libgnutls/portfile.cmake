...
# When built as a static library, the installed gnutls.h still declares public
# symbols with __declspec(dllimport) on Windows, which causes consumers to fail
# linking with `undefined reference to __imp_gnutls_*`. Patch the header so the
# dllimport branch is never taken for static builds.
if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
    vcpkg_replace_string(
        "${CURRENT_PACKAGES_DIR}/include/gnutls/gnutls.h"
        "#if !defined(GNUTLS_INTERNAL_BUILD) && defined(_WIN32)"
        "#if 0 /* vcpkg static build: never use dllimport */"
    )
endif()
